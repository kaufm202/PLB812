...
hisat2_extract_splice_sites.py AtRTD2_19April2016.gtf > at_splicesites.tsv
hisat2_extract_exons.py AtRTD2_19April2016.gtf > at_exons.tsv
...
for sra in ${sra_list}
do
hisat2 -p 10 -x genome_assembly-v3/at_genome_index -1 trimmed_files/${sra}_1_trim_paired.fq.gz -2 trimmed_files/${sra}_2_trim_paired.fq.gz | samtools view -@ 4 -bh | samtools sort -@ 4 > align_outputs-v3/${sra}_aligned.bam 
done
